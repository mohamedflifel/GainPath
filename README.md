...
- 🤖 **AI-Generated Programs** — Personalized plans based on your input
- 🎯 **Goal-Oriented** — Weight loss, muscle gain, cardio, flexibility
- 📅 **Weekly Schedule** — Day-by-day breakdown of exercises
- ⚡ **Instant Results** — Program generated in seconds
- 📱 **Fully Responsive** — Works on mobile, tablet, and desktop
- 🌙 **Modern UI** — Clean, energetic design built for athletes
...
| Vite | Build tool |
| Google Gemini API | AI program generation |
...
```bash
git clone https://github.com/YOUR_USERNAME/gainpath.git
cd gainpath
```
...
👉 **[gain-path.vercel.app](https://gain-path.vercel.app)**
...
<div align="center">
  <i>Built with ❤️ and a lot of reps 💪</i>
</div>
